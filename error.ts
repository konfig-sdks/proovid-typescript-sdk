...
/**
 * This class provides a wrapper for network errors when making requests to Proovid Electronic Verification
 */
export class ProoViDError extends Error {
  /**
   * The response body
   */
